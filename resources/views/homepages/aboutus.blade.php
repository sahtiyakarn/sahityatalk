                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single_feature">
                            ...
                            <div class="desc">
                                <h4 class="mt-3 mb-2">Minimum Fee </h4>
                                <p>
                                    Institute Have Monthly Minimum Fee for Any Courses
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single_feature">
                            ...
                            <div class="desc">
                                ...
                                <p>
                                    All Course Have Online, Offline & Weekend Classes
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single_feature">
                            ...
                            <div class="desc">
                                <h4 class="mt-3 mb-2">Certification / Deploma </h4>
                                <p>
                                    All Courses Have provided Diploma / Certifications
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="testimonial_area section_gap">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="main_title">
                            <h2 class="mb-3">Recently Take Diploma</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="testi_slider owl-carousel">
                        ...
                        <div class="testi_item">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <img src="{{ asset('assets/img/testimonials/t3.jpg') }}" alt="" />
                                </div>
                        ...
                        <div class="testi_item">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <img src="{{ asset('assets/img/testimonials/t4.jpg') }}" alt="" />
                                </div>
                        ...
                        <div class="testi_item">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <img src="{{ asset('assets/img/testimonials/t5.jpg') }}" alt="" />
                                </div>
                        ...
                        <div class="testi_item">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <img src="{{ asset('assetsimg/testimonials/t6.jpg') }}" alt="" />
                                </div>
